...
urlpatterns = [
    ...
    url(r'^(?P<course_code>[a-zA-Z0-9]+)/projects/(?P<project_pk>\d+)/file/(?P<file_id>\d+)/$', views.handle_file, name="download_file"),
    ...
    url(r'^projects/(?P<project_pk>\d+)/assign_all_teams/$', views.assign_all_teams, name="assign_all_teams"),
    ...
    url(r'^(?P<course_code>[a-zA-Z0-9]+)/projects/save/$', views.save_projects_to_file, name="save_projects_to_file"),
    url(r'^(?P<course_code>[a-zA-Z0-9]+)/projects/load/$', views.load_projects_from_file, name="load_projects_from_file")
]
